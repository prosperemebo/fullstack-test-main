...
const credentials = `${MONGO_DATABASE_USERNAME}:${MONGO_DATABASE_PASSWORD}@`.replace(':@', '');
const localDb = `mongodb://${credentials}${MONGO_DATABASE_HOST}:27017/${MONGO_DATABASE_NAME}`;
